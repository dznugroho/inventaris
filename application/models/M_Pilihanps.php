...
class M_Pilihanps extends CI_Model{
	...
	function get_detail(){
		...
		return $this->db->query("SELECT tb_pilihan.kode_pilih,tb_pilihan.kode_usulan,
		nama_bidang,nama_sub,tahun_pengusulan,nama_kegiatan,waktu_mulai,waktu_selesai,
		anggaran,alamat_kegiatan,nama_kecamatan,desa,deskripsi,nama_institusi,alamat_institusi,
		nama_k,nama_d,nama_pengusul,no_telp,tb_perusahaan.nama_perusahaan,tb_perusahaan.alamat,
		tb_perusahaan.no_telp_perusahaan,tb_perusahaan.email,tb_pilihan.dana,tb_pilihan.status_perusahaan
		FROM tb_pilihan 
		JOIN tb_usulan ON tb_usulan.kode_usulan = tb_pilihan.kode_usulan
		JOIN tb_bidang ON tb_bidang.kode_bidang = tb_usulan.kode_bidang 
		JOIN tb_subbidang ON tb_subbidang.kode_subbidang = tb_usulan.kode_subbidang 
