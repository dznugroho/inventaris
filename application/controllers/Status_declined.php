...
class Status_declined extends CI_Controller {
	...
	public function print(){
		...
		$data['decline'] = $this->m_status_usulan->get_excel_decline()->result(); 
        
        $this->load->view('laporan/print_decline',$data);
    }
    ...
    public function excel(){
        ...
        $this->load->view('laporan/excel_decline',$data);
    }
	...
	// 						   ->setTitle("Data Usulan Ditolak")
	// 						   ->setSubject("Data Usulan Ditolak")
	...
	// 	$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA SEMUA USULAN DAN PERUSAHAAN YANG DITOLAK");
	...
	// 	$decline = $this->m_status_usulan->get_excel_decline();

	// 	$no = 1; // Untuk penomoran tabel, di awal set dengan 1
	// 	$numrow = 4; // Set baris pertama untuk isi tabel adalah baris ke 4
	// 	foreach($decline->result_array() as $row){ // Lakukan looping pada variabel siswa
