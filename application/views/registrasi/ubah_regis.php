        ...
        <div class="main-content">
         ...
         <h1>Kelola Berkas</h1>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <form role="form" method="POST" action="<?php echo site_url('register/update_register');?>">
                  ...
                  <div class="form-group col-6">
                        ...
                        <select class="form-control" name="nama_kecamatan" id="kode_kecamatan">
                    ...
                    <div class="card-footer text-right">
                      <button type="submit" class="btn btn-primary" href="<?php echo site_url('register'); ?>">Submit</button>
                    </div>
                  </form>
                </div>
              </div>
