                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="alamat_kegiatan" placeholder="Nama Jalan"  value="<?php echo set_value('alamat_kegiatan'); ?>">  
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control kode_k" name="kode_k" readonly>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control kode_w" name="kode_w" readonly>
