      ...
      <div class="navbar-bg"></div>
        ...
        <section class="section">
          ...
          <div class="row">
            ...
            <a class="btn btn-icon icon-left btn-primary" href="<?php echo base_url('status_declined/excel');?>"><i class="fa fa-download"></i> Excel</a>
            </div>
            </div>
            <div class="row">
              <div class="col-12">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped" id="mytable">
                        ...
                        <tbody>
                            <?php
                              $no = 0;
                              foreach ($declined->result() as $row):
                                $no++;
                            ?>
                            <tr>
                              <td><?php echo $no;?></td>
