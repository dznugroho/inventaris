    ...
    <div class="main-wrapper">
      <div class="navbar-bg">
        ...
        <div class="main-content">
         ...
         <h1>Kelola Sub Bidang</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?php echo site_url('dashboard'); ?>">Dashboard</a></div>
              <div class="breadcrumb-item">Edit Sub Bidang</div>
            </div>
          </div>
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <form role="form" method="POST" action="<?php echo site_url('infrastruktur/update');?>">
                    <div class="card-body">
                      <div class="form-group">
                        <label>Kode Sub Bidang</label>
                        <input type="text" class="form-control" name="kode_subbidang" readonly value="<?=$kode_subbidang?>" >
                      </div>
                      <div class="form-group">
                        <label>Nama Sub Bidang</label>
                        <input type="text" class="form-control" name="nama_sub" placeholder="Nama Subbidang" value="<?=$nama_sub?>">
                      </div>
                    </div>
