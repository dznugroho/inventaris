<div class="main-sidebar">
    <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Data Wilayah</span></a></li>
              <li class="nav-item dropdown">
              ...
              <li><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Input Berkas</span></a></li>
              <li class="nav-item dropdown">
